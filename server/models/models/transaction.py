...
class Transaction(db.Model):
    ...
    order_id_long = db.Column(db.Integer, nullable=False)
    contract_id_long = db.Column(db.Integer, nullable=False)
    order_id_short = db.Column(db.Integer, nullable=False)
    contract_id_short = db.Column(db.Integer, nullable=False)
